...
// Si tu Navbar está en el RootLayout, aparecerá automáticamente aquí.
// Si no, podrías importar y renderizar <Navbar /> arriba de <main />.

// 👉 Opcional: marca esta página como no indexable desde el App Router (layout por ruta).
...
// ====== Brand Icons (SVGs puros, “apple-like”) ======
  ...
  return (
    <main className="relative min-h-[88vh] w-full overflow-hidden">
      ...
      <section className="relative mx-auto max-w-5xl px-6 pt-14 pb-16">
        ...
        >
          Tip: atajos directos — <code>/qr?to=wa</code>, <code>/qr?to=ig</code>,{" "}
          <code>/qr?to=fb</code>
        </motion.div>
      </section>
    </main>
